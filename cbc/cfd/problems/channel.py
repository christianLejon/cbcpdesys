...
"""    
#from cbc.cfd.tools.dolfin_utility import MeshFunction_CL
...
class channel(NSProblem):
    ...
    def gen_mesh(self):
        ...
        m = RectangleMesh(Point(0., -1.), Point(self.L, 1.), self.prm['Nx'], self.prm['Ny'])
    ...
    def create_boundaries(self):
        self.mf = MeshFunction('size_t', self.mesh, 1) # Facets
